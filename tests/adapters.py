...
from cs336_basics.Normalizaiton import RMSNorm
from cs336_basics.RoPE import RotaryPositionalEmbedding
from cs336_basics.Softmax import softmax
from cs336_basics.Attention import scaled_dot_product_attention, MHA
...
def run_linear(
    ...
    linear.load_state_dict({"weight": weights})  # module can load vars
...
def run_embedding(
    ...
    embedding.load_state_dict({"weight": weights})  # module can load vars
...
def run_swiglu(
    ...
    swiglu = SwiGLU(d_model, d_ff, device=w2_weight.device, dtype=w2_weight.dtype)
...
def run_transformer_lm(
    ...
    # indicese = input = x = batches of the  tokens seq

    return tf.forward(in_indices)
...
def run_rmsnorm(
    ...
    rmsnorm.load_state_dict({"weight": weights})  # module can load vars
